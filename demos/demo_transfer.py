#!/usr/bin/env python3
"""Demo: Transfer Money Flow

Tests the complete transfer flow with confirmation.
"""
import sys
sys.path.insert(0, '.')
...
def main():
    print("=" * 60)
    print("DEMO: Transfer Money Flow")
    print("=" * 60)
    ...
    conversations = [
        ("Complete Transfer in One Turn", [
            "Transfer $200 from my savings to my spending account",
            "Yes",
        ]),
        ...
        ("Cancel Transfer", [
            "Transfer $500 to my vacation fund",
            "No, cancel that",
        ]),
    ]
    ...
    for title, messages in conversations:
        ...
        context = engine.start_session(f"demo_transfer_{title}")
